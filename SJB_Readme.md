...
- **index.html** — The complete, working prototype of the site
  (drop on netlify.com/drop to publish in 60 seconds)
- **framer-asset-kit.html** — Visual reference for all components
  (open in browser while building in Framer)
...
All are free via Google Fonts.
Add in Framer: Site Settings → Fonts → Add Google Font.
