...
- Conferences using **[[Contrarian Harrison Owen|Open Space Technology]]** don't have to worry if their expensive keynote speaker doesn't show up, because they don't need one! Instead, participants are riveted by having to step up and step in to create the essence of the conference themselves. 
  
- Organizations using **open content** or **open source software** like [[Wikipedia Started as the Nupedia|Wikipedia]] and Wikimedia (its software platform) don't have to pay licenses, use Digital Rights Management software to protect their content and enforce it all. Instead, the content and software are available for others to use, on purpose. 

Here's a playlist of four videos that go deeper into why trust costs less: 
