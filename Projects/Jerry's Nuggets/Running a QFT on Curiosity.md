...
2. **Produce Questions** – People generate lots of questions _without discussion, judgment, or answering._
...
- It **protects raw curiosity** from critique during generation.
    
- It **teaches people HOW to ask questions**, not just _that_ curiosity matters.
    
- It works in any group size, including Zoom.
    
- It creates **psychological safety + intellectual spark** quickly.
...
- Allows people to **experience curiosity**, not just talk about it.
    
- Reveals what people _really_ wonder about when freed from judgment.
    
- Surfaces social and cultural forces that suppress curiosity.
    
- Builds a shared landscape of questions you can map, cluster, or relate to your “Design from Trust” frame.
...
“Tonight we’re going to explore a question many of us feel quietly: _Have we lost our curiosity?_ Instead of debating it, we’re going to use a method created by the Right Question Institute called the **Question Formulation Technique**. It gives us a way to surface what our curiosity is actually doing.”
...
“This statement isn’t a question. It’s just a stimulus. Your task is to _ask questions about it._ Not to agree or disagree.”
...
- First 2 minutes: shallow questions
    
- Minutes 3–6: real concerns & tensions
    
- Last 2 minutes: surprising meta-questions about curiosity itself
...
- Closed = can be answered with a word or two
    
- Open = require explanation or discussion.”
...
- Convert **one closed → open**
    
- Convert **one open → closed**
...
People become aware of how their curiosity _expands or narrows_ depending on question type.

  

Facilitate quick share-outs:

- “What did you notice in the conversion exercise?”
...
- Social forces suppressing curiosity
    
- Education & work
    
- Trust, agency, autonomy
...
- “Where are the questions dense? Where are they thin?”
    
- “What seems unasked?”
    
- “What do these questions tell you about the _state of our curiosity_?”
    
- “What assumptions show up across questions?”
...
- Ask a child what they’re curious about
    
- Reverse one of your assumptions
    
- Host a curiosity lunch conversation
    
- Practice “asking before telling” at work
    
- Start a ‘question log’ for a day
...
- A **slide deck** for this exact 90-minute session
    
- A **facilitator script** you can read verbatim
    
- A **Google Doc template** for the QFT stages
    
- A **follow-up email** you can send participants
    
- A **short video script** introducing QFT + curiosity
