...
# The EV Trifecta + Humpyards
 
*Some thoughts on our transportation future.* 

<iframe width="560" height="315" src="https://www.youtube.com/embed/q4qsgc0lYaM?si=SCRyyo83d2lbY-4K" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- The EV Trifecta: Autonomous, Electric, Shared.
- Passenger compartments as flexible, designable pods.
- Battery swapping, done better. 
### The Trifecta

My Trifecta is an older wish. It’s been surpassed by the [Transportation Quad](https://bra.in/7jbXZB): Autonomous, _Connected_, Electric, and Shared/Service, which conveniently spells ACES (or CASE if you change the order).
...
Finally, the [humpyard](http://en.wikipedia.org/wiki/Classification_yard) story is my inspiration for fast battery swapping. I’m not suggesting every battery-swap station feature such a hump, but instead asking why battery swaps can’t be nearly instantaneous.
...
Battery swapping is already successful with [scooters in Asia](https://www.youtube.com/shorts/fDfE_pX0AfE), which is of course a simpler scenario.

With cars, it’s been a struggle that may be turning a corner: The battery-swap startup [Ample](https://en.wikipedia.org/wiki/Ample_\(company\)) went bankrupt in 2015, but [NIO](https://en.wikipedia.org/wiki/Nio_Inc.) is racking up the swaps, and the Chinese government seems to be aiming in this direction.
### 10x
