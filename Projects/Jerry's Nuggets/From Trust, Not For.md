...
Choosing the Goldilocks-sized dialog box is what Gebbia means by Design for Trust. It is a useful practice and likely increased host trust in the system, as well as the number of transactions the system attracts. But it doesn't shift the usual producer-consumer relationship at all. 
