...
Designing from ([[From Trust, Not For|not for]]) trust usually isn't a patch to existing systems. It requires thoughtful (re)design that follows a set of principles.  
